...
import { Stats } from '../components/StatsC';
import { ServiceCard } from '../components/ServiceC';
import { BeforeAfter } from '../components/beforeC';
import {Testimonials} from '../components/TestimonialsC';
import { QuoteForm } from '../components/QuoteForm';
import { SEO } from '../components/SEO';
import { SERVICESC, PROJECTSC } from '../constants';
    ...
    <div className="grain-overlay">
      ...
      <section className="py-32 bg-white" id="services">
        <div className="container mx-auto px-6">
          <RevealHeader 
            subtitle="Bespoke Styling Programs" 
            title="Premium Services" 
          />
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {SERVICESC.map((service, i) => (
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="relative">
              ...
              >
                <img 
                  src="/images/shine-shop.webp" 
                  alt="Car detailing service in action" 
              ...
              <div className="absolute -bottom-12 -right-12 p-12 glass shadow-2xl rounded-[40px] max-w-sm hidden md:block">
                <p className="text-white font-display text-2xl font-black italic tracking-tighter mb-4">
                  "Because your vehicle deserves more than just a wash."
                </p>
...
/>
    ...
    desc: 'We use premium products and professional techniques designed to protect your vehicle’s finish while delivering exceptional results.'
  },
  {
    icon: MapPin,
    title: 'Mobile Convenience',
    desc: 'Our team comes to your home or workplace, saving you valuable time without compromising on quality.'
  },
  {
    icon: Clock,
    title: 'Reliable Service',
    desc: 'From punctual arrivals to meticulous attention to detail, we respect both your schedule and your investment.'
  }
                ].map((item, i) => (
                  <motion.div 
                    key={i}
      ...
      <section id="projects">
        <BeforeAfter projects={PROJECTSC} />
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            >
              <div>
                ...
                <h3 className="heading-editorial text-4xl mb-6">Premium Detail <br /> <span className="text-brand-accent">Save 15%</span></h3>
                <p className="text-white/40 font-sans max-w-sm mb-10">Book a Full Detail Package this month and save 15%.</p>
              </div>
              <Link to="/quote" className="inline-flex items-center gap-4 text-brand-secondary font-display font-bold uppercase tracking-widest text-xs group">
                Book & Save <ArrowRight className="group-hover:translate-x-2 transition-transform" />
              </Link>
            </motion.div>
            ...
            >
              <div>
                <span className="text-brand-accent font-display font-medium tracking-[0.4em] uppercase text-[10px] mb-6 block">MEMBERSHIP PROGRAM</span>
                <h3 className="heading-editorial text-4xl text-brand-dark mb-6">Keep It Clean <br /> <span className="italic">Year-Round</span></h3>
                <p className="text-gray-500 font-sans max-w-sm mb-10">Monthly maintenance plans with exclusive pricing and scheduled service.</p>
              </div>
