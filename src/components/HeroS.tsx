        ...
        <div className="max-w-5xl">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-6xl md:text-[8vw] lg:text-[10vw] font-display font-black text-white leading-tight sm:leading-[0.85] tracking-[-0.05em] uppercase mb-12">
              <span>RESTORING</span> <br />
              <span className="text-transparent stroke-white stroke-2" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.5)' }}>GLOSS</span> <br />
              <span className="text-brand-accent">VEHICLE</span>
            </h1>

            <div className="grid md:grid-cols-2 gap-12 items-end">
              <div>
                <p className="text-lg md:text-xl text-white/70 font-sans leading-relaxed mb-10 max-w-sm">
From exterior showroom shine to deep chemical-free interior sterilizing, Greenstone Atlantic delivers exceptional results with bespoke convenience directly at your location.                </p>
              ...
              <div className="hidden md:flex flex-col items-start lg:items-end">
                <div className="glass-dark p-8 rounded-[40px] border border-white/10 max-w-xs animate-float">
                  ...
                  <p className="text-white/40 text-xs uppercase tracking-widest font-bold">
                    Not Paid Until Customer Smiles
                  </p>
                </div>
              </div>
            </div>
